...
class AppointmentRepositoryTest {
    ...
    void shouldReturnTopDoctors() {
        ...
        appointmentRepository.save(Appointment.builder().doctor(d1).appointmentTime(LocalDateTime.now()).build());
        appointmentRepository.save(Appointment.builder().doctor(d1).appointmentTime(LocalDateTime.now().plusHours(1)).build());
